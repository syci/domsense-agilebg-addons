...
class purchase_order_line_master(osv.osv):
    ...
    def _get_uom_id(self, cr, uid, context=None):
        return self.pool.get('purchase.order.line')._get_uom_id(cr, uid, context=context)
    ...
    def _prepare_order_line(self, cr, uid, term_line, master_line, group_index=0, context=None):
        ...
        on_change_res = order_line_pool.onchange_product_id(cr, uid, [],
            ...
            name=master_line.name, price_unit=master_line.price_unit, notes=False, context=context)
